...
- **Toolset Organization**: 6 toolsets group related tools by functionality — analysis (15 tools), query (3 tools), navigation (4 tools), safety (1 tool), diagnostic (2 tools), index (2 tools).
