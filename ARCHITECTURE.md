...
+==================+===========================+====================+
         ...
         v                    v                      v
+===================================================================+
|  MCP Tool Layer (22 tools + 2 discovery meta-tools)                    |
|  analyze_code_structure | java_patterns | code_diff | code_smell_detector | code_clone_detection |
|  error_recovery | health_score | get_code_outline | query_code | read_partial | list_files |
...
| `mcp/` | MCP server, 22 tools + 2 discovery meta-tools, SDK, intent aliases, streamable HTTP, tool registry |
