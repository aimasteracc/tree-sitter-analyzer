...
from tree_sitter_analyzer.exceptions import SecurityError, PathTraversalError, RegexSecurityError
from tree_sitter_analyzer.security import SecurityValidator, ProjectBoundaryManager, RegexSafetyChecker
    ...
    def test_comprehensive_path_validation(self):
        ...
        for path, base_path, should_be_valid, error_keyword in test_cases:
            ...
            if should_be_valid:
                ...
                if error_keyword:
                    assert error_keyword.lower() in error.lower(), f"Expected '{error_keyword}' in error: {error}"
