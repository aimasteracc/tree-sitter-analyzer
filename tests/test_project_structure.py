...
class TestProjectStructure:
    ...
    def test_v2_directory_exists(self, project_root: Path) -> None:
        """Test that V2 project root exists and contains the main package."""
        assert project_root.exists()
        assert project_root.is_dir()
        # After cleanup: repo root is the V2 project root (no v2/ subdir)
        assert (project_root / "tree_sitter_analyzer_v2").exists()

    def test_required_directories_exist(self, project_root: Path) -> None:
        """Test that all required directories exist (post-cleanup structure)."""
        required_dirs = [
            "tree_sitter_analyzer_v2",
            "tree_sitter_analyzer_v2/core",
            "tree_sitter_analyzer_v2/formatters",
            "tree_sitter_analyzer_v2/graph",
            "tree_sitter_analyzer_v2/languages",
            ...
            "tree_sitter_analyzer_v2/security",
            "tests",
            "tests/unit",
            "tests/integration",
            "tests/fixtures",
