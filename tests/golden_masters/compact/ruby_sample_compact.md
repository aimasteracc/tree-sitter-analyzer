...
| User#authenticate | (Any): | + | 36-40 | 2 | - |
| User#update_profile | (Any): | + | 43-47 | 3 | - |
| User#active? | (): | + | 50-52 | 1 | - |
...
| AdminUser#grant_permission | (Any): | + | 103-105 | 2 | - |
| AdminUser#revoke_permission | (Any): | + | 107-109 | 1 | - |
| AdminUser#update_profile | (Any): | + | 112-115 | 2 | - |
...
| UserRepository#find | (Any): | + | 148-154 | 3 | - |
| UserRepository#save | (Any): | + | 156-162 | 2 | - |
...
| with_transaction | (Any): | + | 205-214 | 2 | - |