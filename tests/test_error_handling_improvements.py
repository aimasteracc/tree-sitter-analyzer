...
from tree_sitter_analyzer.mcp.utils.error_handler import (
    MCPError, ErrorCategory, ErrorSeverity, ErrorHandler,
    handle_mcp_errors, get_error_handler
)
...
class TestErrorHandlerImprovements:
    ...
    def test_initialization_error_detection(self):
        ...
        init_error = RuntimeError("Server not fully initialized. Please wait for initialization to complete.")
    ...
    def test_error_severity_classification(self):
        ...
        test_cases = [
            ...
            (RuntimeError("Server not fully initialized"), ErrorSeverity.LOW),  # Special case
        ]
