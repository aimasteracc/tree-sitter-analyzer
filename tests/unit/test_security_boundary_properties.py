...
file_extension = st.sampled_from([
    ".py", ".java", ".js", ".ts", ".txt", ".md", ".json", ".xml", ".yaml", ".yml",
    ".css", ".html", ".sql", ".rb", ".php", ".go", ".rs", ".kt", ".cs",
])
...
def absolute_path_outside_project(draw):
    ...
    if platform.system() == "Windows":
        ...
        path_parts = [draw(safe_name) for _ in range(draw(st.integers(min_value=1, max_value=3)))]
    ...
    **Validates: Requirements 3.4, 10.5**
    ...
    def test_property_4_path_traversal_rejected(self, temp_project_dir, traversal_path):
        ...
        **Validates: Requirements 3.4, 10.5**
        ...
        is_valid, error_msg = validator.validate_file_path(traversal_path, temp_project_dir)
    ...
    def test_property_4_absolute_paths_outside_boundary_rejected(self, temp_project_dir, abs_path):
        """
        **Feature: test-coverage-improvement, Property 4: Security Boundary Enforcement**
        ...
        **Validates: Requirements 3.4, 10.5**
        ...
        assume(not str(Path(abs_path).resolve()).startswith(str(Path(temp_project_dir).resolve())))
    ...
    @settings(max_examples=100, suppress_health_check=COMMON_HEALTH_CHECKS)
    @given(rel_path=relative_path_within_project())
    def test_property_4_boundary_manager_accepts_internal_paths(self, temp_project_dir, rel_path):
        """
        **Feature: test-coverage-improvement, Property 4: Security Boundary Enforcement**
        ...
        **Validates: Requirements 3.4, 10.5**
        ...
        assert is_within, \
            f"Path within project should be accepted: {full_path}"

    @settings(max_examples=100, suppress_health_check=COMMON_HEALTH_CHECKS)
    @given(abs_path=absolute_path_outside_project())
    def test_property_4_boundary_manager_rejects_external_paths(self, temp_project_dir, abs_path):
        """
        **Feature: test-coverage-improvement, Property 4: Security Boundary Enforcement**
        ...
        **Validates: Requirements 3.4, 10.5**
        ...
        assert not is_within, \
            f"Path outside project should be rejected: {abs_path}"

    @settings(max_examples=100, suppress_health_check=COMMON_HEALTH_CHECKS)
    @given(traversal_path=path_traversal_attempt())
    def test_property_4_boundary_manager_rejects_traversal(self, temp_project_dir, traversal_path):
        """
        **Feature: test-coverage-improvement, Property 4: Security Boundary Enforcement**
    ...
    @settings(max_examples=100, suppress_health_check=COMMON_HEALTH_CHECKS)
    @given(rel_path=relative_path_within_project())
    def test_property_4_validate_and_resolve_returns_resolved_path(self, temp_project_dir, rel_path):
        """
        **Feature: test-coverage-improvement, Property 4: Security Boundary Enforcement**
    ...
    @settings(max_examples=100, suppress_health_check=COMMON_HEALTH_CHECKS)
    @given(traversal_path=path_traversal_attempt())
    def test_property_4_validate_and_resolve_rejects_traversal(self, temp_project_dir, traversal_path):
        """
        **Feature: test-coverage-improvement, Property 4: Security Boundary Enforcement**
...
class TestSecurityBoundaryEdgeCases:
    ...
    **Validates: Requirements 3.4, 10.5**
    ...
    def test_property_4_empty_paths_rejected(self, temp_project_dir, empty_or_whitespace):
        """
        **Feature: test-coverage-improvement, Property 4: Security Boundary Enforcement**
        ...
        **Validates: Requirements 3.4, 10.5**
        ...
        is_valid, error_msg = validator.validate_file_path(empty_or_whitespace, temp_project_dir)
    ...
    def test_property_4_boundary_manager_empty_path_rejected(self, temp_project_dir, name):
        """
        **Feature: test-coverage-improvement, Property 4: Security Boundary Enforcement**
    ...
    @settings(max_examples=100, suppress_health_check=COMMON_HEALTH_CHECKS)
    @given(abs_path=absolute_path_outside_project())
    def test_property_4_get_relative_path_returns_none_for_external(self, temp_project_dir, abs_path):
        """
        **Feature: test-coverage-improvement, Property 4: Security Boundary Enforcement**
...
class TestSecurityValidatorIntegrationProperties:
    ...
    **Validates: Requirements 3.4, 10.5**
    ...
    @settings(max_examples=100, suppress_health_check=COMMON_HEALTH_CHECKS)
    @given(rel_path=relative_path_within_project())
    def test_property_4_is_safe_path_consistent_with_validate(self, temp_project_dir, rel_path):
        """
        **Feature: test-coverage-improvement, Property 4: Security Boundary Enforcement**
    ...
    @settings(max_examples=100, suppress_health_check=COMMON_HEALTH_CHECKS)
    @given(rel_path=relative_path_within_project())
    def test_property_4_validate_path_alias_consistent(self, temp_project_dir, rel_path):
        """
        **Feature: test-coverage-improvement, Property 4: Security Boundary Enforcement**
    ...
    @given(
        glob_pattern=st.one_of(
            ...
            st.just("**/*.java"),
            st.just("src/*.ts"),
            st.builds(lambda n: f"*.{n}", n=st.sampled_from(["py", "java", "js", "ts"])),
        )
    )
    def test_property_4_valid_glob_patterns_accepted(self, temp_project_dir, glob_pattern):
        """
        **Feature: test-coverage-improvement, Property 4: Security Boundary Enforcement**
    ...
    def test_property_4_dangerous_glob_patterns_rejected(self, temp_project_dir, dangerous_glob):
        """
        **Feature: test-coverage-improvement, Property 4: Security Boundary Enforcement**
...
class TestProjectBoundaryManagerInitializationProperties:
    ...
    **Validates: Requirements 3.4, 10.5**
    ...
    @given(name=safe_name)
    def test_property_4_file_as_root_raises_security_error(self, temp_project_dir, name):
        """
        **Feature: test-coverage-improvement, Property 4: Security Boundary Enforcement**
    ...
    @settings(max_examples=50, suppress_health_check=COMMON_HEALTH_CHECKS)
    @given(name=safe_name)
    def test_property_4_valid_directory_initializes_successfully(self, temp_project_dir, name):
        """
        **Feature: test-coverage-improvement, Property 4: Security Boundary Enforcement**
