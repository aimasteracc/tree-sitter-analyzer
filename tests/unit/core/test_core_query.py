...
class TestExecuteQueryWithLanguageName:
    ...
    def test_execute_with_language_name_capture_processing_error(
        self, executor, mock_tree, mock_language
    ):
    ...
    def test_execute_with_language_name_execution_error(
        self, executor, mock_tree, mock_language
    ):
    ...
    def test_execute_with_language_name_unexpected_error(
        self, executor, mock_tree, mock_language
    ):
