...
[![Tests](https://img.shields.io/badge/tests-10200%2B%20passed-brightgreen.svg)](#-quality--testing)
...
| **Tool Registry** | Centralized tool organization with 6 toolsets (analysis, query, navigation, safety, diagnostic, index) — 29 MCP tools including understand_codebase, semantic_impact, quick_risk_assessment, error_recovery, java_patterns, health_score, test_coverage, security_scan, ci_report for quality gates | [Architecture](docs/architecture.md) |
