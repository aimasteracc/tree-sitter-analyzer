...
| **Tool Registry** | Centralized tool organization with 6 toolsets (analysis, query, navigation, safety, diagnostic, index) — 20 MCP tools including health_score, ci_report for quality gates | [Architecture](docs/architecture.md) |
