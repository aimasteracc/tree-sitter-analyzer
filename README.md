...
| **Tool Registry** | Centralized tool organization with 6 toolsets (analysis, query, navigation, safety, diagnostic, index) — 18 MCP tools including code_diff, code_smell_detector for code quality analysis | [Architecture](docs/architecture.md) |
