...
| **Tool Registry** | Centralized tool organization with 6 toolsets (analysis, query, navigation, safety, diagnostic, index) — 28 MCP tools including understand_codebase, semantic_impact, quick_risk_assessment, error_recovery, java_patterns, health_score, security_scan, ci_report for quality gates | [Architecture](docs/architecture.md) |
