...
| **Tool Registry** | Centralized tool organization with 6 toolsets (analysis, query, navigation, safety, diagnostic, index) — 22 MCP tools including error_recovery, java_patterns, health_score, ci_report for quality gates | [Architecture](docs/architecture.md) |
