...
| **Tool Registry** | Centralized tool organization with 6 toolsets (analysis, query, navigation, safety, diagnostic, index) — 24 MCP tools including semantic_impact, quick_risk_assessment, error_recovery, java_patterns, health_score, ci_report for quality gates | [Architecture](docs/architecture.md) |
