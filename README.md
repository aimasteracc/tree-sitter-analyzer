...
| **Tool Registry** | Centralized tool organization with 6 toolsets (analysis, query, navigation, safety, diagnostic, index) — 21 MCP tools including java_patterns, health_score, ci_report for quality gates | [Architecture](docs/architecture.md) |
