...
# Extractor version constant — kept in sync with ast_cache.py. Version 32
# invalidates caches for loader-dictionary aliases and bound loaders.
_AST_CACHE_EXTRACTOR_VERSION = 32
