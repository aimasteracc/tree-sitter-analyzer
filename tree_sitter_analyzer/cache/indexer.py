...
# Extractor version constant — kept in sync with ast_cache.py. Version 34
# invalidates caches for computed and header-retained loader semantics.
_AST_CACHE_EXTRACTOR_VERSION = 34
