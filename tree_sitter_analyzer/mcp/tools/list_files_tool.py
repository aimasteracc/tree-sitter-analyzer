...
class ListFilesTool(BaseMCPTool):
    ...
    def validate_arguments(self, arguments: dict[str, Any]) -> bool:
        ...
        for key in ["glob", "follow_symlinks", "hidden", "no_ignore", "full_path_match", "absolute"]:
    ...
    async def execute(self, arguments: dict[str, Any]) -> dict[str, Any]:
        ...
        limit = fd_rg_utils.clamp_int(
            arguments.get("limit"), fd_rg_utils.DEFAULT_RESULTS_LIMIT, fd_rg_utils.MAX_RESULTS_HARD_CAP
        )
