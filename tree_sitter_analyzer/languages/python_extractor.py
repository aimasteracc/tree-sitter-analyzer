...
Core extraction logic for Python code analysis: functions, classes,
variables, imports, comprehensions, and expressions.
Extracted from python_plugin.py for maintainability (was 1959 LOC).
"""
