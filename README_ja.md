...
[![テスト](https://img.shields.io/badge/tests-1599%20passed-brightgreen.svg)](#品質保証)
...
[![バージョン](https://img.shields.io/badge/version-1.3.1-blue.svg)](https://github.com/aimasteracc/tree-sitter-analyzer/releases)
...
- ✅ **包括的テストカバレッジ** - 1599テスト、74.97%カバレッジ
...
- プロジェクト：tree-sitter-analyzer v1.3.1
