...
[![Tests](https://img.shields.io/badge/tests-18691%20passed-brightgreen.svg)](#-品質とテスト)
...
>
> **ベンチマーク後の改善 (2026-05-30):** BM25 プレフィルターが 40k シンボルを ~400 に絞り込んでからコサイン再ランク — セマンティック検索が 133× 高速化。このベンチマーク実行には含まれない；大規模シンボル数のリポジトリ (Django / Excalidraw) では再実行時にトークン効率の改善が期待される。
