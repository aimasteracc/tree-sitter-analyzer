...
def main():
    ...
    # 重新生成文件
    mappings = {
        ("examples/test_markdown.md", "full"): "tests/golden_masters/full/markdown_test_full.md",
        ("examples/test_markdown.md", "compact"): "tests/golden_masters/compact/markdown_test_compact.md",
        ("examples/test_markdown.md", "csv"): "tests/golden_masters/csv/markdown_test_csv.csv",
        ("examples/sample.cpp", "full"): "tests/golden_masters/full/cpp_sample_full.md",
        ("examples/sample.cpp", "compact"): "tests/golden_masters/compact/cpp_sample_compact.md",
    }
