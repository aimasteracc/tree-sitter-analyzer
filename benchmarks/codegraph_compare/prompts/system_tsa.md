...
6. Hard budget: use at most 2 TSA CLI calls. The first broad `codegraph-query` call should end with `.answer()` and is the answer pack; after one optional targeted follow-up, stop and answer from the available evidence.
