...
| ID | Task | Owner role | Depends on | Acceptance and verification |
|---|---|---|---|---|
| NO1-008A | Seven-repository model-free setup qualification | Benchmark Lead | NO1-003C | exact source partitions, zero unallowed parse errors, pinned tool/repo fingerprints, and no model callbacks; any failure blocks NO1-008B and later model-backed phases |
