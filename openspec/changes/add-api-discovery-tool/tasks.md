...
5. **MCP Tool Integration**: `api_discovery` tool in navigation toolset
...
- schema: project_root, frameworks, min_depth, format
- TOON output with grouped endpoints
```
...
- [ ] Create `analysis/api_discovery.py` module
- [ ] Implement `ApiEndpoint` dataclass
- [ ] Implement Flask route detection (@app.route, @bp.route)
- [ ] Implement FastAPI endpoint detection (@app.get, @app.post, @router)
- [ ] Write unit tests (15+ tests)

### Sprint 2: Multi-Framework Support
- [ ] Django: urlpatterns + @api_view detection
- [ ] Express: app.get/post/put/delete + router detection
- [ ] Spring Boot: @GetMapping/@PostMapping detection
- [ ] Add integration tests (10+ tests)

### Sprint 3: MCP Tool Integration
- [ ] Create `mcp/tools/api_discovery_tool.py`
- [ ] Implement schema (project_root, frameworks, format)
- [ ] Register to ToolRegistry (navigation toolset)
- [ ] Add TOON format output with endpoint grouping
- [ ] Write tool tests (10+ tests)

## Success Criteria

- [ ] 35+ tests passing
- [ ] Detects endpoints in test projects with <10% false positive rate
- [ ] ruff check passes, mypy --strict passes
- [ ] Integrated into MCP toolset (32 tools total)
