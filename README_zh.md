...
[![测试](https://img.shields.io/badge/tests-68%20test%20files-brightgreen.svg)](#质量保证)
...
[![版本](https://img.shields.io/badge/version-1.6.1.1-blue.svg)](https://github.com/aimasteracc/tree-sitter-analyzer/releases)
...
- Python版本：3.10+
- 项目版本：tree-sitter-analyzer v1.6.1.1
